...
const ReactNativeIcon = forwardRef(
  (
    ...
    const start = async () => {
      ...
      // Effet de vague sur les anneaux
      ...
      rings.forEach((ring, i) => {
        animationControls.current.push(
          animate(
            ring,
            { opacity: [1, 0.7, 1] },
            { duration: 3, ease: "easeInOut", repeat: Infinity, delay: i * 1 },
          ),
        );
      });
    };
    ...
    const stop = () => {
      ...
      animate(".orbit-system", { rotate: 0, scale: 1 }, { duration: 0.6 });
